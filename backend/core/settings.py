...
# CSRF Trusted Origins para Produção (HTMX funcionar em HTTPS)
CSRF_TRUSTED_ORIGINS = [
    'https://*.onrender.com',
    'http://localhost',
    'http://127.0.0.1',
]
# Se houver um domínio customizado, ele deve ser adicionado aqui via env ou manualmente
CUSTOM_DOMAIN = config('CUSTOM_DOMAIN', default=None)
if CUSTOM_DOMAIN:
    CSRF_TRUSTED_ORIGINS.append(f'https://{CUSTOM_DOMAIN}')

# Configurações de Segurança para Produção (Render/HTTPS)
if not DEBUG:
